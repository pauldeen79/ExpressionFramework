...
[ReturnValue(ResultStatus.Ok, typeof(bool), "true or false", "True when both values are string, and the left value does not end with the right value, otherwise false")]
