...
public class NowExpressionParserTests
{
    ...
    public NowExpressionParserTests()
    {
    ...
    {
        // Arrange
        var parser = new NowExpressionParser();
        var contextValue = new Mock<IDateTimeProvider>().Object;
        var functionParseResult = new FunctionParseResult("Now", new[] { new FunctionArgument(new FunctionParseResult("Context", Enumerable.Empty<FunctionParseResultArgument>(), CultureInfo.InvariantCulture, contextValue)) }, CultureInfo.InvariantCulture, contextValue);
        ...
        result.Value.Should().BeOfType<NowExpression>();
    }
    ...
    public void Parse_Returns_Error_When_ArgumentParsing_Fails()
    {
        // Arrange
        var parser = new NowExpressionParser();
        var functionParseResult = new FunctionParseResult("Now", new[] { new FunctionArgument(new FunctionParseResult("UNKNOWN_FUNCTION", Enumerable.Empty<FunctionParseResultArgument>(), CultureInfo.InvariantCulture, null)) }, CultureInfo.InvariantCulture, null);
