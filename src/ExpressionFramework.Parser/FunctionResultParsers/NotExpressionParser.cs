...
{
    public class NotExpressionParser : CrossCutting.Utilities.Parsers.Contracts.IFunctionResultParser, ExpressionFramework.Parser.Contracts.IExpressionResolver
    {
        ...
        {
            if (functionParseResult.FunctionName.ToUpperInvariant() != "NOT")
            {
        ...
        public NotExpressionParser(CrossCutting.Utilities.Parsers.Contracts.IExpressionParser parser)
        {
            _parser = parser;
        }
