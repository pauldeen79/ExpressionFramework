...
{
    public class StringLengthExpressionParser : CrossCutting.Utilities.Parsers.Contracts.IFunctionResultParser, ExpressionFramework.Parser.Contracts.IExpressionResolver
    {
        ...
        {
            if (functionParseResult.FunctionName.ToUpperInvariant() != "STRINGLENGTH")
            {
        ...
        public StringLengthExpressionParser(CrossCutting.Utilities.Parsers.Contracts.IExpressionParser parser)
        {
            _parser = parser;
        }
