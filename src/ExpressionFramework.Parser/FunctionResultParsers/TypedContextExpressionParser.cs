...
{
    public class TypedContextExpressionParser : CrossCutting.Utilities.Parsers.Contracts.IFunctionResultParser, ExpressionFramework.Parser.Contracts.IExpressionResolver
    {
        ...
        {
            if (functionParseResult.FunctionName.ToUpperInvariant() != "TYPEDCONTEXT")
            {
        ...
        public TypedContextExpressionParser(CrossCutting.Utilities.Parsers.Contracts.IExpressionParser parser)
        {
            _parser = parser;
        }
