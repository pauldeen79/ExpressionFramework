...
{
    public class TypedConstantExpressionParser : CrossCutting.Utilities.Parsers.Contracts.IFunctionResultParser, ExpressionFramework.Parser.Contracts.IExpressionResolver
    {
        ...
        {
            if (functionParseResult.FunctionName.ToUpperInvariant() != "TYPEDCONSTANT")
            {
        ...
        public TypedConstantExpressionParser(CrossCutting.Utilities.Parsers.Contracts.IExpressionParser parser)
        {
            _parser = parser;
        }
