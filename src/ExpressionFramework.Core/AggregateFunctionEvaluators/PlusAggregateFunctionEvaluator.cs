...
public class PlusAggregateFunctionEvaluator : AggregateFunctionEvaluatorBase<PlusAggregateFunction>
{
    protected override Result<IAggregateFunctionResultValue?> TryEvaluate(PlusAggregateFunction function,
                                                                          bool isFirstItem,
                                                                          object? value,
                                                                          object? context,
