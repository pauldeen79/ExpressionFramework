...
public class MinusFunctionEvaluator : IFunctionEvaluator
{
    ...
    {
        result = null;
        if (!(function is MinusFunction minusFunction))
        {
            return false;
        }

        var plusValue = evaluator.Evaluate(sourceItem, minusFunction.MinusExpression);
