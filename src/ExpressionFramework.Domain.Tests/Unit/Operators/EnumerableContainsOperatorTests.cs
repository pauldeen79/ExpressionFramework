...
{
    [Fact]
    public void Evaluate_Returns_False_When_LeftSequence_Does_Not_Contain_Right_Value()
    {
        // Arrange
        var sut = new EnumerableContainsOperator();
    ...
    [Fact]
    public void Evaluate_Returns_True_When_LeftSequence_Contains_Right_Value()
    {
        // Arrange
        var sut = new EnumerableContainsOperator();
