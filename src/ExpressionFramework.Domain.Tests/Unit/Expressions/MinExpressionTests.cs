...
public class MinExpressionTests
{
    ...
    {
        // Arrange
        var sut = new MinExpression(null);
    ...
    {
        // Arrange
        var sut = new MinExpression(new ErrorExpression("Kaboom"));
    ...
    {
        // Arrange
        var sut = new MinExpression(new DelegateExpression(x => Convert.ToInt32(x)));
