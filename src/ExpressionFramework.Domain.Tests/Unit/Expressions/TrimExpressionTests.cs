...
public class TrimExpressionTests
{
    ...
    {
        // Arrange
        var sut = new TrimExpression(new TypedConstantResultExpression<string>(Result<string>.Error("Kaboom")), null);
    ...
    {
        // Arrange
        var expression = new TrimExpressionBuilder().WithExpression("Some text").Build();
