...
public class SingleOrDefaultExpressionTests
{
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(null, null);
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(null, new ConstantExpression("default value"));
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new InvalidExpression("Something bad happened"), null);
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new ErrorExpression("Something bad happened"), null);
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new ConstantExpression("None boolean value"), null);
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new DelegateExpression(x => x is int i && i > 10), null);
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new DelegateExpression(x => x is int i && i > 10), new ConstantExpression("default"));
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(null, new ConstantExpression(true));
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new DelegateExpression(x => x is int i && i > 1), null);
