...
public class SingleOrDefaultExpressionTests
{
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new[] { 1, 2, 3 }, new(x => x is int i && i > 10));
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new[] { 1, 2, 3 }, new(x => x is int i && i > 10), "default");
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new[] { 1, 2, 3 }, new(_ => true));
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new[] { 1, 2 }, new(x => x is int i && i > 1));
    ...
    {
        // Arrange
        var expression = new SingleOrDefaultExpression(new[] { "a", "b", "c" }, new(_ => true), "some default value");
