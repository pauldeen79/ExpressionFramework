...
public class SingleOrDefaultExpressionTests
{
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new EmptyExpression(), null, null);
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new ConstantExpression(12345), null, null);
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new ConstantExpression(new[] { 1, 2, 3 }), new InvalidExpression("Something bad happened"), null);
    ...
    {
        // Arrange
        var sut = new SingleOrDefaultExpression(new ConstantExpression(new[] { 1, 2, 3 }), new ErrorExpression("Something bad happened"), null);
