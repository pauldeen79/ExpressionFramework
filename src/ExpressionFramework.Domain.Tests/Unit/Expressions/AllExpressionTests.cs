...
public class AllExpressionTests
{
    ...
    [Fact]
    public void Evaluate_Returns_Invalid_When_PredicateExpression_Is_empty()
    {
        // Arrange
    ...
    [Fact]
    public void ValidateContext_Returns_Item_When_PredicateExpression_Is_Empty()
    {
        // Arrange
        var sut = new AllExpression(null!);
        ...
        // Assert
        result.Select(x => x.ErrorMessage).Should().BeEquivalentTo(new[] { "Predicate is required" });
    }
