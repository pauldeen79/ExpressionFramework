...
public class FirstOrDefaultExpressionTests
{
    ...
    {
        // Arrange
        var sut = new FirstOrDefaultExpression(new EmptyExpression(), default, default);
    ...
    {
        // Arrange
        var sut = new FirstOrDefaultExpression(new ConstantExpression(12345), default, default);
    ...
    {
        // Arrange
        var sut = new FirstOrDefaultExpression(new[] { 1, 2, 3 }, x => x is int i && i > 10);
    ...
    {
        // Arrange
        var sut = new FirstOrDefaultExpression(new[] { 1, 2, 3 }, x => x is int i && i > 10, "default");
    ...
    {
        // Arrange
        var sut = new FirstOrDefaultExpression(_ => new[] { 1, 2, 3 });
    ...
    {
        // Arrange
        var sut = new FirstOrDefaultExpression(_ => new[] { 1, 2, 3 }, x => x is int i && i > 1);
    ...
    {
        // Arrange
        var expression = new FirstOrDefaultExpression(_ => new[] { 1, 2, 3 }, x => x is int i && i > 1, _ => "some default value");
