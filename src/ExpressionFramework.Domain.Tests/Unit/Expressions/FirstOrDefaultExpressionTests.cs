...
public class FirstOrDefaultExpressionTests
{
    ...
    {
        // Arrange
        var sut = new FirstOrDefaultExpression(default(object?));
    ...
    {
        // Arrange
        var sut = new FirstOrDefaultExpression(_ => 12345);
    ...
    {
        // Arrange
        var expression = new FirstOrDefaultExpression(new ConstantExpression(Enumerable.Empty<object>()), null, null);
