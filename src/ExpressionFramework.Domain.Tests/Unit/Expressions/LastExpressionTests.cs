...
public class LastExpressionTests
{
    ...
    {
        // Arrange
        var sut = new LastExpression(null);
    ...
    {
        // Arrange
        var sut = new LastExpression(new InvalidExpression("Something bad happened"));
    ...
    {
        // Arrange
        var sut = new LastExpression(new ErrorExpression("Something bad happened"));
    ...
    {
        // Arrange
        var sut = new LastExpression(new ConstantExpression("None boolean value"));
    ...
    {
        // Arrange
        var sut = new LastExpression(new DelegateExpression(x => x is int i && i > 10));
    ...
    {
        // Arrange
        var sut = new LastExpression(new DelegateExpression(x => x is int i && i > 1));
