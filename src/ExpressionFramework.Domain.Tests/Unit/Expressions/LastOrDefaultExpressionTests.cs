...
public class LastOrDefaultExpressionTests
{
    ...
    {
        // Arrange
        var sut = new LastOrDefaultExpression(new EmptyExpression(), null, null);
    ...
    {
        // Arrange
        var sut = new LastOrDefaultExpression(new ConstantExpression(12345), null, null);
    ...
    {
        // Arrange
        var sut = new LastOrDefaultExpression(new ConstantExpression(Enumerable.Empty<object>()), null, null);
    ...
    {
        // Arrange
        var sut = new LastOrDefaultExpression(new ConstantExpression(Enumerable.Empty<object>()), null, new ConstantExpression("default value"));
    ...
    {
        // Arrange
        var sut = new LastOrDefaultExpression(new ConstantExpression(new[] { 1, 2, 3 }), new InvalidExpression(new ConstantExpression("Something bad happened")), null);
    ...
    {
        // Arrange
        var sut = new LastOrDefaultExpression(new ConstantExpression(new[] { 1, 2, 3 }), new ErrorExpression(new ConstantExpression("Something bad happened")), null);
    ...
    {
        // Arrange
        var sut = new LastOrDefaultExpression(new ConstantExpression(new[] { 1, 2, 3 }), new ConstantExpression("None boolean value"), null);
    ...
    {
        // Arrange
        var sut = new LastOrDefaultExpression(new ConstantExpression(new[] { 1, 2, 3 }), new DelegateExpression(x => x is int i && i > 10), null);
    ...
    {
        // Arrange
        var sut = new LastOrDefaultExpression(new ConstantExpression(new[] { 1, 2, 3 }), new DelegateExpression(x => x is int i && i > 10), new ConstantExpression("default"));
    ...
    {
        // Arrange
        var sut = new LastOrDefaultExpression(new ConstantExpression(new[] { 1, 2, 3 }), null, null);
    ...
    {
        // Arrange
        var sut = new LastOrDefaultExpression(new ConstantExpression(new[] { 1, 2, 3 }), new DelegateExpression(x => x is int i && i > 1), null);
    ...
    {
        // Arrange
        var expression = new LastOrDefaultExpression(new ConstantExpression(new[] { "a", "b", "cc" }), null, null);
