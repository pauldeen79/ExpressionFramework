...
public class MultiplyAggregatorTests
{
    ...
    {
        // Arrange
        var sut = new MultiplyAggregator();
    ...
    {
        // Arrange
        var sut = new ReflectionAggregatorDescriptorProvider(typeof(MultiplyAggregator));
        ...
        result.Name.Should().Be(nameof(MultiplyAggregator));
