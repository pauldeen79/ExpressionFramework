...
{
    public ComposableEvaluatable(object? leftExpression, Operator @operator, object? rightExpression, Combination? combination = null, bool startGroup = false, bool endGroup = false)
