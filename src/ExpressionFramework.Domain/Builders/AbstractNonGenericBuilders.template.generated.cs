...
namespace ExpressionFramework.Domain.Builders
{
    public abstract partial class AggregatorBuilder : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static implicit operator ExpressionFramework.Domain.Aggregator(AggregatorBuilder entity)
        {
            return entity.Build();
        }
    ...
    public abstract partial class EvaluatableBuilder : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static implicit operator ExpressionFramework.Domain.Evaluatable(EvaluatableBuilder entity)
        {
            return entity.Build();
        }
    ...
    public abstract partial class ExpressionBuilder : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static implicit operator ExpressionFramework.Domain.Expression(ExpressionBuilder entity)
        {
            return entity.Build();
        }
    ...
    public abstract partial class OperatorBuilder : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static implicit operator ExpressionFramework.Domain.Operator(OperatorBuilder entity)
        {
            return entity.Build();
        }
