...
public class MultiplyAggregateFunctionTests
{
    [Fact]
    public void TryEvaluate_Returns_Correct_Result_When_Value_Is_Byte()
    {
        // Arrange
        var sut = new MultiplyAggregateFunctionEvaluator();
        const byte value = 2;
    ...
    public void TryEvaluate_Returns_Null_Result_When_Value_Is_First()
    {
        ...
        // Act
        var actual = sut.TryEvaluate(new MultiplyAggregateFunction(), true, 2, null, expressionEvaluatorMock.Object, expression);
