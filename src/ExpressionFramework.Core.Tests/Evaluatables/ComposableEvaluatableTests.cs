...
public class ComposableEvaluatableTests : TestBase<ComposableEvaluatableBuilder>
{
    ...
    public class Ctor : ComposableEvaluatableTests
    {
        [Fact]
    ...
    public class Evaluate : ComposableEvaluatableTests
    {
        [Fact]
