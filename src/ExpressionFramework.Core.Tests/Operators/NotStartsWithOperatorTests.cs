...
public class NotStartsWithOperatorTests : TestBase<NotStartsWithOperator>
{
    public class Evaluate : NotStartsWithOperatorTests
    {
        [Fact]
        ...
        public void Returns_Success_When_Left_Value_And_Right_Value_Are_Both_Of_Type_String()
        {
            ...
            // Act
            var result = sut.Evaluate("string", "g", StringComparison.Ordinal);
