...
dotnet t4plus run -f CodeGeneration.template BasePath:../ $T4.TempPath:./ GenerateMultipleFiles:True DryRun:False
...
rem t4plus run -f CodeGeneration.template BasePath:../ $T4.TempPath:./ GenerateMultipleFiles:True DryRun:False
